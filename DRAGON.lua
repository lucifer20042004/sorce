...
print('\27[0;31m☩━━━━━☩ᴱᵛᴱᴸ☩━━━━━☩n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end 
os.execute('lua DRAGON.lua')
end
...
sudo_users = {SUDO,1373616147,1804978483}   
...
local UserName = (data.username_ or "SOURCE_EVEL")
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/SOURCE_EVEL)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/SOURCE_EVEL"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'فامبير مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 🕸 من أحسن السورسات على التليجرام سورس ايفيل 🕸
...
send(msg.chat_id_,0," 🕸 الـعـضو  : {["..data.first_name_.."](T.ME/SOURCE_EVEL)}\n 🕸 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🕸 عذرا  ↚ {["..data.first_name_.."](T.ME/SOURCE_EVEL)}\n 🕸 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' :̤̈DEV LUCIFER:',url="t.me/LLucifeerr"},{text = ':̤̈𝐓W𝐀𝐒𝐎𝐋', url="t.me/TWASOL7_bot"}},
{{text = ':̤̈DEV_VAMBAIR:', url="t.me/DEV_VAMBAIR"}},
{{text = '00:00', url="t.me/SOURCE_EVEL"}},
}
local msg_id = msg.id_/2097152/0.5
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/baar_lucifer/10683&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
function(arg,data) 
usertext = '\n 🕸 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_EVEL')..')'
...
usertext = '\n 🕸 الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'SOURCE_EVEL')..')'
status  = '\n 🕸 تم حظرو عام من الجروبات '
texts = usertext..status
...
local TextE = "\n☩━━━━━☩ᴱᵛᴱᴸ☩━━━━━☩\n 🕸 علامة تعني { ✔️ } ملف مفعل\n 🕸 علامة تعني { ✖ } ملف معطل\n 🕸 قناة سورس ايفيل↓\n".." 🕸 [اضغط هنا لدخول](t.me/SOURCE_EVEL) \n"
local NumFile = 0
...
' }\n'..' 🕸  الايدي بالصوره  ↚ { '..idph..
' }\n'..' 🕸  الرفع  ↚ { '..setadd..
' }\n'..' 🕸  الحظر  ↚ { '..banm..' }\n\n 🕸═───═❲[𝔼𝕍𝔼𝕃](t.me/SOURCE_EVEL)❳═───═ 🕸\n 🕸 قناة سورس ايفيل↓\n [ ❲[𝔼𝕍𝔼𝕃](t.me/SOURCE_EVEL)❳](t.me/SOURCE_EVEL) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'☩━━━━━☩ᴱᵛᴱᴸ☩━━━━━☩\nاضغط علي الاسم ليتم نسخه\n☩━━━━━☩ᴱᵛᴱᴸ☩━━━━━☩ٴ\n 🕸 ❲[𝔼𝕍𝔼𝕃](t.me/SOURCE_EVEL)❳ 🕸 ')
end
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/SOURCE_EVEL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/SOURCE_EVEL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/SOURCE_EVEL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/SOURCE_EVEL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/SOURCE_EVEL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SOURCE_EVEL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SOURCE_EVEL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SOURCE_EVEL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/SOURCE_EVEL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت مجرد عضو قميل🌚 😂](t.me/SOURCE_EVEL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/SOURCE_EVEL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/SOURCE_EVEL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك..للوسيفر وفامبير يضربوك😹😹💗](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[رايح تحك....زي ميكو😹😉💗](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[كمر....اسود🌚](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[كمر....ابيض🌝](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚💕](t.me/SOURCE_EVEL)')
return false
end
end
end
...
{
{text = '𓆩𝒔𝒐𝒖𝒓𝒄𝒆 𝒆𝒗𝒆𝒍🕸𓆪', url="t.me/SOURCE_EVEL"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Teext =[[
 🕸   بك في مميزات سورس ايفيل 🕸  
 🕸   مميزات الخاصه بسورس 🕸 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', url="https://t.me/SOURCE_EVEL/149"},{text = 'كتبات',url="https://t.me/SOURCE_EVEL/155"}},   
{{text = 'انصحني', url="https://t.me/SOURCE_EVEL/151"},{text = 'لو خيروك', url="https://t.me/SOURCE_EVEL/152"}}, 
{{text = 'الصراحه', url="https://t.me/SOURCE_EVEL/161"},{text = 'حروف', url="https://t.me/SOURCE_EVEL/153"}}, 
{{text = 'رزله', url="https://t.me/SOURCE_EVEL/156"},{text = 'رد عليه يابوت', url="https://t.me/SOURCE_EVEL/160"}}, 
{{text = 'بتكره دا', url="https://t.me/SOURCE_EVEL/157"},{text = 'نكته', url="https://t.me/SOURCE_EVEL/154"}}, 
{{text = 'غنيلي', url="https://t.me/SOURCE_EVEL/158"}},
{{text = 'نسبه جمالي', url="https://t.me/SOURCE_EVEL/188"},{text = 'اليتيوب', url="https://t.me/SOURCE_EVEL/194"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'لعبه البات', url="https://t.me/SOURCE_EVEL/138"},{text = 'لعبه الرياضيات',url="https://t.me/SOURCE_EVEL/139"}},   
{{text = 'لعبه المختلف', url="https://t.me/SOURCE_EVEL/148"},{text = 'لعبه السمايلات', url="https://t.me/SOURCE_EVEL/141"}}, 
{{text = 'لعبه التخمين', url="https://t.me/SOURCE_EVEL/143"},{text = 'لعبه العكس', url="https://t.me/SOURCE_EVEL/144"}}, 
{{text = 'لعبه الاسرع', url="https://t.me/SOURCE_EVEL/145"},{text = 'لعبه الانكليزي', url="https://t.me/SOURCE_EVEL/146"}}, 
{{text = 'لعبه حزوره', url="https://t.me/SOURCE_EVEL/142"},{text = 'لعبه المعاني', url="https://t.me/SOURCE_EVEL/147"}}, 
{{text = 'لعبه الامثله', url="https://t.me/SOURCE_EVEL/140"},{text = 'عقاب', url="https://t.me/SOURCE_EVEL/198"}},
{{text = 'مريم', url="https://t.me/SOURCE_EVEL/209"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '00:00', url="t.me/SOURCE_EVEL"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
