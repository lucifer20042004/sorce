...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' :̤̈DEV_VAMBAIR',url="t.me/OSDDR"}},
{{text = ':̤̈DEV LUCIFER:', url="t.me/Q_0_ll"}},
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🌚♥️](t.me/SOURCE_EVEL)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🌚💕](t.me/SOURCE_EVEL)')
return false
end
end
end
