...
if text == '• ━━━━━━❪𝘉𝘖𝘠𝘒𝘈 𝘈𝘓𝘌𝘟🇮🇹❫━━━━━━ •' and DevSoFi(msg) then
local Text = [[ 
[𝘉𝘖𝘠𝘒𝘈 𝘈𝘓𝘌𝘟🇮🇹](t.me/Boyka_alex)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝘉𝘖𝘠𝘒𝘈 𝘈𝘓𝘌𝘟🇮🇹', url="t.me/Boyka_alex"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'حربي مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
local Text = [[
اهلا بك في سورس ولف لو عايز بوت بارخص الاسعار
تواصل معنا🔽
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'بويكا' or text == 'بويكا كبير اليكس' or text == 'بويكا القامد' or text == 'مبرمج السورس' or text =='نايكك الكل' or text == 'صاحب الابليكيشن' or text == 'مبرمج السورس' then
local Text = [[
المبرمج بـويـكـا الـقمـد لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᴅᴇᴠᴇʟᴏᴘᴇʀ',url="t.me/Boyka_alex"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sorce_wWolf/24&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == "اذكار" or text == "ازكار" then 
local TWEET_Msg = { 
...
if text == "بوستات" or text == "بوست" then 
local TWEET_Msg = { 
...
if text == "باد" or text == "الباد" then 
local TWEET_Msg = { 
" نكت بنت كام مره🥵؟ ",
...
' }\n'..' ⋆  الايدي بالصوره  ↚ { '..idph..
' }\n'..' ⋆  الرفع  ↚ { '..setadd..
' }\n'..' ⋆  الحظر  ↚ { '..banm..' }\n\n ⋆═───═❲[ѕᴏụʀᴄᴇ ᴡᴏʟғ](t.me/SOURCE_WOOLF)❳═───═ ⋆\n ⋆ قناة سورس ولف↓\n [ ❲[ѕᴏụʀᴄᴇ ᴡᴏʟғ](t.me/SOURCE_WOOLF)❳](t.me/SOURCE_WOOLF) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/sorce_wWolf/22&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'سلام'then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/sorce_wWolf/23&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
