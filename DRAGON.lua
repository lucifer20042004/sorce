...
if res ~= 200 then
print('\27[0;31m≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝑳f𓃠━━━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝑳f𓃠━━━━━━≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝑳f𓃠━━━━━━≫ ━\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
echo "≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝑳f𓃠━━━━━━≫ ≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝑳f𓃠━━━━━━≫ ━"
exit 1
fi
if [ ! $token ]; then
echo "≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝑳f𓃠━━━━━━≫ ≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝑳f𓃠━━━━━━≫ ━ ━"
...
sudo_users = {SUDO,1312010731,1854415047,1757394723,1879324805}   
...
var = true  
elseif tonumber(user_id) == tonumber(1312010731) then
var = true  
...
if tonumber(user_id) == tonumber(1312010731) then  
var = 'مالك السورس'
...
local UserName = (data.username_ or "soorcewolf")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ѕᴏụʀᴄᴇ ᴡᴏʟғ.")  
...
{{text = 'قناه السورس ●', url="http://t.me/soorcewolf"}},
}
...
send(msg.chat_id_, msg.id_,' 🕸︙ اصدار سورس 𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝑳f𓃠\n 🕸︙ الاصدار »{v2.6.0}')
end
...
usertext = '\n 🕸︙ العضو » ['..result.title_..'](t.me/'..(username or 'soorcewolf')..')'
status  = '\n 🕸︙ تم ترقيته مطور'
...
usertext = '\n 🕸︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'soorcewolf')..')'
status  = '\n 🕸︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🕸︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'soorcewolf')..') \n 🕸︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," 🕸︙ العضو : {["..data.first_name_.."](T.ME/soorcewolf)}\n 🕸︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🕸︙ عذرا » {["..data.first_name_.."](T.ME/soorcewolf)}\n 🕸︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = {
  "غيرت صورتك ليش يكلب السكك😹😹",
  "الصوره الجديده جمدان يبا🔥",
...
local Text = [[ 
[🇮🇹مرحبا بك في سورس ولف الاعظم🇮🇹](t.me/soorcewolf)
🇮🇹𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝙒𝙊𝙇𝙁🇮🇹
🇮🇹Benvenuto nella fonte del lupo🇮🇹
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝘿𝙀𝙑 𝙑𝙊𝘿𝙀𝙆𝘼🇮🇹',url="t.me/DV_Vo_Dk_A1"}}, 
{{text = '𝔻𝔼𝕍 𝕃𝕌ℂ𝕀𝔽𝔼ℝ🇮🇹',url="t.me/LLucifeerr"}}, 
{{text = '𝙈𝙀𝙆𝙊🇮🇹', url="t.me/DEVMEKO"}}, 
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝑳f🇮🇹', url="t.me/soorcewolf"}}, 
{{text = '𝕋W𝔸𝕊𝕆𝕃🇮🇹', url="t.me/test741125878_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'فوديكا' or text == 'فودكا' or text == 'مبرمج السورس' then
local Text = [[
🇮🇹المبرمج فوديكا 🇮🇹
...
if text == 'ميكو' or text == 'ابورودي' or text == 'جزره' then
local Text = [[
🇮🇹صاحب السورس ميكو🇮🇹
...
if text == 'تواصل' or text == 'بوت التواصل' or text == 'تواصل ولف' then
local Text = [[
🇮🇹بوت تواصل ولف🇮🇹
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 🕸︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'soorcewolf')..') \n 🕸︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🕸︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'soorcewolf')..') \n 🕸︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " 🕸︙ لا تسطيع حظر مبرمج السورس لوسيفر عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1312010731) then  
...
if tonumber(result.id_) == tonumber(1312010731) then  
send(msg.chat_id_, msg.id_, " 🕸︙ لا تسطيع حظر مطور السورس ")
return false 
end
if tonumber(result.id_) == tonumber(1854415047) then  
send(msg.chat_id_, msg.id_, " 🕸︙ لا تسطيع حظر مبرمج السورس لوسيفر ")
return false 
end
...
if tonumber(userid) == tonumber(1312010731) then  
send(msg.chat_id_, msg.id_, " 🕸︙ لا تسطيع حظر مطور السورس عام ")
return false 
end
...
local TextE = "\n≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝑳f𓃠━━━━━━≫\n 🕸︙ علامة تعني { ✔️ } ملف مفعل\n 🕸︙ علامة تعني { ✖ } ملف معطل\n 🕸︙ قناة سورس 𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝑳f𓃠↓\n".." 🕸︙ [اضغط هنا لدخول](t.me/soorcewolf) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 🕸︙ عذرا الملف لايدعم سورس 𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝑳f𓃠\n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🕸︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'soorcewolf')..')'
status  = '\n 🕸︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🕸︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🕸︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'soorcewolf')..')'
...
if text == 'العاب ولف' or text == 'العاب خارقه' or text == 'العاب متطوره' then  
local Text = [[  
الاهلا في قائمه الالعاب المتطوره سورس 𝐖𝐎𝑳f𓃠🎮
...
"سؤال ينرفزك ؟ ", 
" ليه فوديكا اجدع خلق ربنا؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"ليه لوسيفر بيحب رحمه بسته؟ ", 
"كم مره حبيت؟ ", 
...
' }\n'..' 🕸︙  الايدي بالصوره » { '..idph..
' }\n'..' 🕸︙  الرفع » { '..setadd..
' }\n'..' 🕸︙  الحظر » { '..banm..' }\n\n≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝑳f𓃠━━━━━━≫\n 🕸︙ قناة سورس 𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝑳f𓃠↓\n [🔥┇ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ѕᴏụʀᴄᴇ ᴡᴏʟғ.](t.me/soorcewolf) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🕸︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'soorcewolf')..')'..'\n 🕸︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
for k, v in pairs(list) do
if tonumber(v.user_id_) ~= tonumber(bot_id)  and tonumber(v.user_id_) ~= tonumber(1312010731) then
...
database:set(bot_id.."soorcewolf:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."soorcewolf:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."soorcewolf:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."soorcewolf:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"🕸︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."soorcewolf:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."soorcewolf:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس 𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝑳f𓃠يعني لو بكتهن راح اعرفك انت الاخذتهن
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'soorcewolf')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_,' 🕸︙ علي الطلاق انت دخلت عبر الرابط🌝') 
end
end,nil)
else
...
{
{text = '𓆩 𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝑳f𓃠𓆪', url="t.me/soorcewolf"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@soorcewolf','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
